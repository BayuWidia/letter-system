    ...
    <div class="col-md-12">
      <div class="box box-danger">
        <div class="box-header">
          <a href="{{route('surat.masukan.tambah')}}" class="btn bg-navy btn-flat margin">Tambah Berita</a>
        </div><!-- /.box-header -->
        <div class="box-body">
                  ...
                  <td>
                    ...
                    @else
                      @if($key->flag_approved=="1")
                        <span class="badge bg-blue" data-toggle="tooltip" title="Surat Masukan sudah diapproved"><i class="fa fa-thumbs-up"></i></span>
                      @elseif($key->flag_approved=="0")
                        <span class="badge bg-red" data-toggle="tooltip" title="Menunggu persetujuan Admin"><i class="fa fa-thumbs-down"></i></span>
                      @endif
                    @endif
                  </td>
                  <td>
